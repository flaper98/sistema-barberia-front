...
import { LoyaltyAccount, LoyaltyMovement, LoyaltyConfig } from '../../core/models/loyalty.model';
...
export class LoyaltyService {
  ...
  getRewards(): Observable<unknown[]> {
    return this.http
      .get<ApiResponse<unknown[]>>(`${this.url}/rewards`)
      .pipe(map(r => r.data ?? []));
  }
}
